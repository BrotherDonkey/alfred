...
function query(program, env) {
    var _this = this;
    var wiflQ = "SELECT [System.Id], [System.WorkItemType], [System.Title], [System.AssignedTo], [System.State], [System.Tags] FROM workitems WHERE [System.TeamProject] = @project AND [System.WorkItemType] <> '' AND [System.Tags] CONTAINS '1216' AND [System.AreaPath] = 'Engineering\\Teams\\UXE\\Fox \uD83E\uDD8A' ORDER BY [System.AssignedTo]";
    program
        .version('0.0.1')
        .command('query')
        .description('get a query')
        .action(function (arg, opt, cmdLine) { return __awaiter(_this, void 0, void 0, function () {
        var prPrompt, command;
